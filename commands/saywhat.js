...
class SayCmd extends Command {
  constructor (client) {
    super(client, {
      name: "saywhat",
      description: "Makes a 'What you just said !' meme.",
      category: "Meme Maker",
      usage: "",
      enabled: true,
      guildOnly: false,
  ...
  async run (message, args, level, reply) { // eslint-disable-line no-unused-vars
    ...
    const image = await fsn.readFile("./templates/52.png");
    ...
    await msg.delete();
    message.channel.send("Your 'What you just said !' meme is ready:", attachment);
  }
}
