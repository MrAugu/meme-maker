...
class YeahCmd extends Command {
  constructor (client) {
    super(client, {
      name: "yeah",
      description: "Makes a 'hell Yeah' meme.",
      category: "Meme Maker",
      usage: "",
      enabled: true,
      guildOnly: false,
  ...
  async run (message, args, level, reply) { // eslint-disable-line no-unused-vars
    ...
    const image = await fsn.readFile("./templates/42.png");
    ...
    await msg.delete();
    message.channel.send("Your 'Hell Yeah' meme is ready:", attachment);
  }
}

module.exports = YeahCmd;