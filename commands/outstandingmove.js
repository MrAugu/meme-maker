...
class MoveCmd extends Command {
  constructor (client) {
    super(client, {
      name: "outstandingmove",
      description: "Makes an 'Outstanding Move' meme.",
      category: "Meme Maker",
      usage: "",
      enabled: true,
      guildOnly: false,
  ...
  async run (message, args, level, reply) { // eslint-disable-line no-unused-vars
    ...
    let topText = await this.client.awaitReply(message, "Please tell me your Outstanding Move", 60000);
    if (topText === false) {
    ...
    const image = await fsn.readFile("./templates/56.jpg");
    ...
    const newMeme = new Canvas(618.8, 510)
      .addImage(image, 0, 0, 618.8, 510)
      .setColor("#000000")
