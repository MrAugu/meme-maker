...
class ObamaCmd extends Command {
  constructor (client) {
    super(client, {
      name: "obama",
      description: "Makes 'Obama' meme.",
      category: "Meme Maker",
      usage: "",
      enabled: true,
      guildOnly: false,
  ...
  async run (message, args, level, reply) { // eslint-disable-line no-unused-vars
    ...
    const image = await fsn.readFile("./templates/43.png");
    ...
    await msg.delete();
    message.channel.send("Your 'obama' meme is ready:", attachment);
  }
}

module.exports = ObamaCmd;